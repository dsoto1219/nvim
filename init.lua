...
local options = {
  ...
  --  See `:help 'clipboard'`
  --   NOTE: Might need to change for WSL compatibility
  --
...
-- -- If using windows, make powershell the default
...
if operating_system == 'Windows_NT' then
  ...
  options = vim.tbl_extend('error', options, powershell_options)
end
...
vim.keymap.set('n', '<leader>cm', function()
  ...
  if bfo:find 'c' and bfo:find 'r' and bfo:find 'o' then
    ...
    ofo:remove { 'c', 'r', 'o' }
    print 'Autocommenting off' -- same as :echom
  else
    ofo:append 'c'
    ofo:append 'r'
    ofo:append 'o'
...
end, { desc = 'Toggle autocomenting' })

-- Edit .vimrc
vim.keymap.set('n', '<leader>vm', ':e $MYVIMRC<CR>', { desc = 'Edit $MYVIMRC' })
...
-- The lin  beneath this is called `modeline`. See `:help modeline`
